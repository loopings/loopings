...
<div class="col-md-12">
	<table class="table table-striped table-bordered table-hover">
		<thead>
			<tr>
				<th>
					Nom de l’entreprise propriétaire de l’installation
				</th>
				<th>
					Activité de l’installation
				</th>
				<th>
					Classement du risque de l’installation
				</th>
				<th>
		...
		<tbody>
			...
			<td style="width:50px">
				<a href="#" data-href="icpe/{{$icpe->id}}/edit" data-toggle="modal" data-target="#ModalMod" class="btn btn-link">
					<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
				</a>
			</td>

			<td>
				<form action="icpe/{{$icpe->id}}"  method="POST" id="{{$icpe->id}}">
					<input type="hidden" name="_method" value="DELETE">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					<button class="btn btn-link confirm-delete" type="submit" data-id="{{$icpe->id}}">
...
<div class="col-md-3">
	<div class="dataTables_info" role="status" aria-live="polite">
		<a href="icpe/create" class="btn btn-success btn-lg">
			Ajouter
		</a>
	</div>
</div>
<div class="col-md-3">
	<div class="dataTables_info" role="status" aria-live="polite">
		<h4>Affichage de {{$icpes->count()}} enregistrements sur un total de {{$icpes->total()}}</h4>
	</div>
</div>
<div class="col-md-6">
