	...
	<table class="table table-striped table-bordered table-hover">
		<thead>
			<tr>
				...
				<th>
					Surfaces de cultures permanentes en hectares
				</th>
				<th>
		...
		<tbody>
			...
			<td style="width:50px">
				<a href="#" data-href="agriculture/{{$agriculture->id}}/edit" data-toggle="modal" data-target="#ModalMod" class="btn btn-link">
					<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
				</a>
			</td>

			<td>
				<form action="agriculture/{{$agriculture->id}}"  method="POST" id="{{$agriculture->id}}">
					<input type="hidden" name="_method" value="DELETE">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					<button class="btn btn-link confirm-delete" type="submit" data-id="{{$agriculture->id}}">
...
<div class="col-md-3">
	<div class="dataTables_info" role="status" aria-live="polite">
		<a href="agriculture/create" class="btn btn-success btn-lg">
			Ajouter
		</a>
	</div>
</div>
<div class="col-md-3">
	<div class="dataTables_info" role="status" aria-live="polite">
		<h4>Affichage de {{$agricultures->count()}} enregistrements sur un total de {{$agricultures->total()}}</h4>
	</div>
</div>
<div class="col-md-6">
