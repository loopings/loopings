...
<div class="col-md-12">
	<table class="table table-striped table-bordered table-hover">
		...
		<tbody>
			...
			<tr>
				<td>
					{{$tepospepcv->nom_tepospepcv}}
				</td>
				<td>
					{{$tepospepcv->tepos_ou_pepcv}}
				</td>

				<td>
					{{$tepospepcv->annee_maj}}
				</td>
				<td>
			...
			<td style="width:50px">
				<a href="#" data-href="tepospepcv/{{$tepospepcv->id}}/edit" data-toggle="modal" data-target="#ModalMod" class="btn btn-link">
					<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
				</a>
			</td>

			<td>
				<form action="tepospepcv/{{$tepospepcv->id}}"  method="POST" id="{{$tepospepcv->id}}">
					<input type="hidden" name="_method" value="DELETE">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					<button class="btn btn-link confirm-delete" type="submit" data-id="{{$tepospepcv->id}}">
...
<div class="col-md-3">
	<div class="dataTables_info" role="status" aria-live="polite">
		<a href="tepospepcv/create" class="btn btn-success btn-lg">
			Ajouter
		</a>
	</div>
</div>
<div class="col-md-3">
	<div class="dataTables_info" role="status" aria-live="polite">
		<h4>Affichage de {{$tepospepcvs->count()}} enregistrements sur un total de {{$tepospepcvs->total()}}</h4>
	</div>
</div>
<div class="col-md-6">
