...
@section('content')
<div class="col-md-6">
  {{Form::open(['url' => '/tepospepcv', 'method' => 'post'])}}
  <div class="panel panel-default">
    <div class="panel-heading">Général</div>
    <div class="panel-body">

{{ Form::label('nom_tepospepcv', ' Nom tepospepcv : ') }}
{{ Form::text('nom_tepospepcv','', array('class' => 'form-control')) }}

{{ Form::label('tepos_ou_pepcv', ' Type : ') }}
 {{Form::select('tepos_ou_pepcv', array('TEPOS'=>'TEPOS','PEPCV'=>'PEPCV') ,null, ['placeholder' => 'Sélectionner un type', 'class' => 'form-control'])}}
