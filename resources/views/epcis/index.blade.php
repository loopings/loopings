...
<div class="col-md-12">
  <table class="table table-striped table-bordered table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <div class="tooltip-demo">
            ...
            fax <br>
            courriel<br> 
            vulnerabilite energetique <br>
            libelle du PDU <br>
            etat d'avancement du PDU <br>
            date de validation du PDU <br>
            lien du doc PDU <br>
            libelle du PLH <br>
            etat d'avancement du PLH <br>
            date de validation du PLH <br>
            lien du doc PLH <br>
            doc ofpi <br>
            video epci foncier <br>
            etat de l'EPCI <br>
            resultat de fusion si c'est le cas <br>" type="button" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="">
      ...
      <td style="width:50px">
      <a href="#" data-href="epci/{{$epci->id}}/edit" data-toggle="modal" data-target="#ModalMod" class="btn btn-link">
          <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
        </a>
      </td>

      <td>
      <form action="epci/{{$epci->id}}"  method="POST" id="{{$epci->id}}">
          <input type="hidden" name="_method" value="DELETE">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <button class="btn btn-link confirm-delete" type="submit" data-id="{{$epci->id}}">
...
<div class="col-md-3">
  <div class="dataTables_info" role="status" aria-live="polite">
    <a href="epci/create" class="btn btn-success btn-lg">Ajouter</a>
  </div>
</div>
<div class="col-md-3">
  <div class="dataTables_info" role="status" aria-live="polite">
    <h4>Affichage de {{$epcis->count()}} enregistrements sur un total de {{$epcis->total()}}</h4>
  </div>
</div>
<div class="col-md-6">
