    ...
    <div class="main">
      ...
      <div class="section section-EPCI">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h1 style=" font-family: inherit;font-weight: 500;line-height: 1.1;color: inherit;">{{$epci->nom_groupement}}</h1>
