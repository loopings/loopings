	...
	<div class="row">
		<div class="col col-md-6">
			<div class="jumbotron jumbotron-fluid">
				<div class="container">
					<h5 style="text-align: left;"><i class="glyphicon glyphicon-info-sign"></i> Informations générales</h5>
					<hr class="my-4">
					<p style="text-align: left;">

						<ul class="list-group">
							<li class="list-group-item justify-content-between ">Code INSEE :  <b>{{$comm->code_insee}}</b>  </li>
							<li class="list-group-item justify-content-between">Surface de la commune(en hectares) :   <b >{{$comm->surface_hectares}}</b> </li>
							<li class="list-group-item justify-content-between">Maire : <b >{{$comm->civilite_maire}}&nbsp;{{$comm->prenom_maire}}&nbsp;{{$comm->nom_maire}}</b> </li>
							<li class="list-group-item justify-content-between">Téléphone : <b>{{$comm->telephone}}</b> </li>
							<li class="list-group-item justify-content-between">Fax : <b>{{$comm->fax}}</b></li>
							<li class="list-group-item justify-content-between">Email : <b>{{$comm->email1}} <br>{{$comm->email2}}</b></li>
			...
			<div class="col-6 col-md-6">
				<div class="jumbotron jumbotron-fluid" style="background-color: #d0c6cd ;">
					<div class="container">
						<h5 style="text-align: left;"><i class="glyphicon glyphicon-king"></i> Périmètres de gouvernance</h5>
						<hr class="my-4">
						...
						<p style="text-align: left;">
							...
							<ul class="list-group">
								<li class="list-group-item justify-content-between ">EPCI :  <b>
									@if(!empty($epci)){{$epci->nom_groupement}}@endif</b>  </li>

									<li class="list-group-item justify-content-between ">Territoire 38 :  <b>@if(!empty($terri)) {{$terri->nom_terri38}} @endif</b>  </li>


									<li class="list-group-item justify-content-between ">SCOT :  <b>@if(!empty($scot)){{$scot->nom_scot}}@endif</b>  </li>
						...
						<div class="card">
							<div class="card-block">
								...
								<ul class="list-group">
									...
									<li class="list-group-item justify-content-between ">Synthèse des avis :  <b>{{$comm->lien_synthavis}}</b>  </li>
									@endif
