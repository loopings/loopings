...
<div class="col-md-12">
	<table class="table table-striped table-bordered table-hover">
		<thead>
			<tr>
				<th>
					Nom de la natura2000
				</th>

				<th>
					Départements sur lesquels s’étend la zone Natura
				</th>
		...
		<tbody>
			...
			<tr>
				<td>
					{{$natura2000->nom_natura2000}}
				</td>

				
				<td>
					{{$natura2000->departements}}
				</td>


				<td>
					{{$natura2000->annee_maj}}
				</td>
				<td>
				...
				<td style="width:50px">
					<a href="#" data-href="natura2000/{{$natura2000->id}}/edit" data-toggle="modal" data-target="#ModalMod" class="btn btn-link">
						<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
					</a>
				</td>

				<td>
					<form action="natura2000/{{$natura2000->id}}"  method="POST" id="{{$natura2000->id}}">
						<input type="hidden" name="_method" value="DELETE">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
						<button class="btn btn-link confirm-delete" type="submit" data-id="{{$natura2000->id}}">
...
<div class="col-md-3">
	<div class="dataTables_info" role="status" aria-live="polite">
		<a href="natura2000/create" class="btn btn-success btn-lg">
			Ajouter
		</a>
	</div>
</div>
<div class="col-md-3">
	<div class="dataTables_info" role="status" aria-live="polite">
		<h4>Affichage de {{$natura2000s->count()}} enregistrements sur un total de {{$natura2000s->total()}}</h4>
	</div>
</div>
<div class="col-md-6">
